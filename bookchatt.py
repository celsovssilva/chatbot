...
titulo = tk.Label(janela, text="Envio de WhatsApp Automático", font=("Arial", 12, "bold"))
titulo.pack(pady=10)

botao_iniciar = tk.Button(janela, text="Iniciar", width=25, command=iniciar_envio, bg="green", fg="white")
botao_iniciar.pack(pady=5)

botao_parar = tk.Button(janela, text="Parar", width=25, command=parar_envio, bg="red", fg="white")
...
botao_recomecar = tk.Button(janela, text="Recomeçar do Zero", width=25, command=recomecar_zero, bg="blue", fg="white")
botao_recomecar.pack(pady=5)
